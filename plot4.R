...
#Plot with multiple sub-plots (plot 4)
png(file="plot4.png",width = 480, height = 480, units = "px")

  par(mfrow=c(2,2))
  plot(1:2880,power$Global_active_power,type="l",xaxt='n',
     ylab="Global Active Power",cex.lab=0.9,xlab='')
  axis(1,at=c(0,1440,2880),labels=c('Thu','Fri','Sat'),cex.axis=0.9)

  plot(1:2880,power$Voltage,type="l",xaxt='n',
     ylab="Voltage",cex.lab=0.9,xlab='datetime')
  axis(1,at=c(0,1440,2880),labels=c('Thu','Fri','Sat'),cex.axis=0.9)
  ...
  plot(1:2880,power$Global_reactive_power,type="l",xaxt='n',
     ylab="Global_reactive_power",cex.lab=0.9,xlab='datetime')
  axis(1,at=c(0,1440,2880),labels=c('Thu','Fri','Sat'),cex.axis=0.9)
dev.off()
